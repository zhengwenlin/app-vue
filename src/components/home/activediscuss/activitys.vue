    ...
    <el-card>
         <el-row>
            ...
            <el-col :span="16">
                 ...
                 <el-button 
                 @click="$router.push({name:'addActivity'})"
        ...
        <el-table
            ...
            width="60">
                <template slot-scope="scope">
                    ...
                    <el-tag v-else-if="scope.row.sort == 4" type="success" size="mini">采集</el-tag>
                </template>
            </el-table-column>
            <el-table-column
            label="创建时间"
            ...
            <el-button  plain 
                        size="mini" 
                        type="text" 
                        @click="hanlePreviewActivity(scope.row)"
                        >查看</el-button>
            </template>
        ...
        <el-dialog title="查看问卷" 
                   :visible.sync="previewActivityShow" 
                   width="50%"
                   :fullscreen="false">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="previewActivityShow = false" type="primary">关闭</el-button>
          </div>
        </el-dialog>
    </el-card>
</template>
    ...
    methods:{
        ...
        // 批量删除
         ...
         handleSelectionChange(val){
           ...
           // 查看功能
       async hanlePreviewActivity(rows){
            this.previewActivityShow = true
