    ...
    <el-card>
        ...
        <el-table
            ...
            <template slot-scope="scope"> 
                <span v-if="scope.row.isLook == 1">公开</span>
                <span v-else-if="scope.row.isLook == 2">匿名</span>
            </template>
            </el-table-column>
             <el-table-column
            label="类别"
            ...
            <template slot-scope="scope">
              ...
              <el-button  plain 
                          size="mini" 
                          type="text" 
                          @click="hanleDeleQuesnaire(scope.row)"
                          >删除</el-button>
            <el-button  plain 
                        size="mini" 
                        type="text" 
                        @click="hanlePreviewQuetionnaire(scope.row)"
                        >查看</el-button>
            </template>
        ...
        <el-dialog title="查看问卷" 
                   @close="closeAddCB()"
                   :visible.sync="previewQuesnaireShow" 
                   width="50%"
                   :fullscreen="false">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button @click="previewQuesnaireShow = false" type="primary">关闭</el-button>
          </div>
        </el-dialog>
...
export default {
    ...
    methods:{
       ...
       async loadQuestionnaireList(){
        ...
        // 查看功能
       async hanlePreviewQuetionnaire(rows){
            this.previewQuesnaireShow = true
